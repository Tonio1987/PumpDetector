...
CREATE TABLE IF NOT EXISTS `T_ALGO_EVOL_CRYPTO_EVC` (
  ...
  `EVC_EVOL_VOL_STATUS` int DEFAULT NULL,
  `EVC_EVOL_NB_TRADES_STATUS` int DEFAULT NULL,
  `EVC_EVOL_PRICE_STATUS` int DEFAULT NULL,
  `EVC_EVOL_OP_CL_PRICE_STATUS` int DEFAULT NULL,
